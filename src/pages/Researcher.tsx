...
export default function ResearcherPage() {
  ...
  const proposals = [
  {
    title: "Development and Field Trial of 500 T Capacity SAGES-III for Use with Continuous Miners (Phase-III)",
  ...
  {
    title: "Electrostatic deposition and functionalization of MWCNTs for detection of Coal Mine Methane (CMM)",
    startDate: "10.8.2025",
    endDate: "14.02.2025",
  ...
  {
    title: "Development of an instrument for prediction of roof falls in the goaf area in coal mines",
  ...
  const thrustAreas = {
    "Productivity Improvement": { 
      icon: Shield, 
      color: "bg-indigo-500",
      description: "Advanced technology for improvement of production & productivity"
    },
    "Safety & Environment": { 
      icon: Shield, 
      color: "bg-red-500",
  ...
  const stats = [
    { label: "Total Proposals", value: "3", icon: FileText, color: "text-blue-500" },
    { label: "Accepted", value: "1", icon: CheckCircle, color: "text-green-500" },
    { label: "Under Review", value: "2", icon: Clock, color: "text-yellow-500" },
    { label: "Success Rate", value: "33%", icon: TrendingUp, color: "text-purple-500" },
  ];
            ...
            <div className="space-y-3">
              <div className="flex items-start gap-3 p-3 bg-green-50 rounded-lg">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">Your proposal has been approved by SSRC. Check details.</p>
              ...
              <div className="flex items-start gap-3 p-3 bg-yellow-50 rounded-lg">
                ...
                <div>
                  <p className="font-medium">Action Required: PRO-2023-045 ⚠️</p>
                  <p className="text-sm text-gray-600">Expert reviewer has requested revisions. Please review comments.</p>
